...
Elm.TaskColumn.make = function (_elm) {
   ...
   var Context = F2(function (a,b) {
      return {moveRightAddress: a,moveLeftAddress: b};
   });
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
...
Elm.PersonalKanban.make = function (_elm) {
   "use strict";
   _elm.PersonalKanban = _elm.PersonalKanban || {};
   ...
   var moveTask = F5(function (columns,
   columnId,
   targetColumnId,
   taskId,
   taskDescription) {
      var removeFromColumn = function (_p0) {
         var _p1 = _p0;
         var _p4 = _p1._0;
         var _p3 = _p1._1;
         var _p2 = _p1._2;
         return _U.eq(_p4,columnId) ? {ctor: "_Tuple3"
                                      ,_0: _p4
                                      ,_1: _p3
                                      ,_2: A2($TaskColumn.update,
                                      $TaskColumn.RemoveTask(taskId),
                                      _p2)} : {ctor: "_Tuple3",_0: _p4,_1: _p3,_2: _p2};
      };
      var addTaskToRightColumn = function (_p5) {
         var _p6 = _p5;
         var _p9 = _p6._0;
         var _p8 = _p6._1;
         var _p7 = _p6._2;
         return _U.eq(_p9,targetColumnId) ? {ctor: "_Tuple3"
                                            ,_0: _p9
                                            ,_1: _p8
                                            ,_2: A2($TaskColumn.update,
                                            $TaskColumn.AddTask(taskDescription),
                                            _p7)} : {ctor: "_Tuple3",_0: _p9,_1: _p8,_2: _p7};
      };
      return A2($List.map,
      function (_p10) {
         return removeFromColumn(addTaskToRightColumn(_p10));
      },
      columns);
   });
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return {ctor: "_Tuple2"
                           ,_0: model
                           ,_1: $Effects.none};
         case "TaskColumnAction": var updateColumn = function (_p12) {
              var _p13 = _p12;
              var _p16 = _p13._0;
              var _p15 = _p13._1;
              var _p14 = _p13._2;
              return _U.eq(_p16,_p11._0) ? {ctor: "_Tuple3"
                                           ,_0: _p16
                                           ,_1: _p15
                                           ,_2: A2($TaskColumn.update,_p11._1,_p14)} : {ctor: "_Tuple3"
                                                                                       ,_0: _p16
                                                                                       ,_1: _p15
                                                                                       ,_2: _p14};
           };
         ...
         var updateFirstColumn = F2(function (index,_p17) {
              var _p18 = _p17;
              var _p21 = _p18._0;
              var _p20 = _p18._1;
              var _p19 = _p18._2;
              return _U.eq(index,0) ? {ctor: "_Tuple3"
                                      ...
                                      ,_1: _p20
                                      ,_2: A2($TaskColumn.update,
                                      $TaskColumn.AddTask(_p11._0),
                                      _p19)} : {ctor: "_Tuple3",_0: _p21,_1: _p20,_2: _p19};
           });
   ...
   var view = F2(function (address,model) {
      ...
      model.popup);
      var viewColumnCell = function (_p24) {
         var _p25 = _p24;
         var _p26 = _p25._0;
         ...
         taskColumnContext,
         A2($Signal.forwardTo,address,TaskColumnAction(_p26)),
         _p25._2)]));
      };
...
Elm.Main.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $PersonalKanban = Elm.PersonalKanban.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $StartApp = Elm.StartApp.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var app = $StartApp.start({init: $PersonalKanban.init
                             ,update: $PersonalKanban.update
                             ,view: $PersonalKanban.view
                             ,inputs: _U.list([])});
   var main = app.html;
